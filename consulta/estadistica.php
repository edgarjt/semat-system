                        ...
                        <div class="table-responsive">
                            ...
                            <table class="footable table table-striped" data-page-size="8" data-filter=#filter
                                ...
                                <tr>
                                    ...
                                    <th>
                                        <center>ID LINEA.</center>
                                    </th>
                                    <th>
                                        <center>LINEA</center>
                                    </th>
                                    <th>
                                        <center>DENOMINACION TECNICA</center>
                                    </th>
                                    <th>
                                        <center>UBICACION TECNICA</center>
                                    </th>
                                    <th>
                                        <center>TIPO DE PRODUCTO</center>
                                    </th>
                                    <th>
                                        <center>DIAMETRO NOMINAL</center>
                                    </th>
                                    <th>
                                        <center>DIAMETRO EXTERIOR</center>
                                    </th>
                                    <th>
                                ...
                                foreach ($lineas as $value) {
                                    ...
                                    <tr onmouseover="cambiacolor_over(this)" onmouseout="cambiacolor_out(this)">
                                        ...
                                        <td>
                                            <center><?php echo $value['denominacion_tecnica']; ?></center>
                                        </td>
                                        <td>
                                            <center><?php echo $value['ubicacion_tecnica']; ?></center>
                                        </td>
                                        <td>
                                            <center><?php echo $value['tipo_producto']; ?></center>
                                        </td>
                                        <td>
                                            <center><?php echo $value['diametro_nominal']; ?></center>
                                        </td>
                                        <td>
                                            <center><?php echo $value['diametro_exterior']; ?></center>
                                        </td>
                                        <td>
                                            <img border="0" alt="Calibracion de equipos" src="../img/GRAFICA.png"
                                                 width="23" height="23"
                                                 onclick="graficarradar(<?php echo $value['id_linea']; ?>);">
                                        </td>
                                    </tr>
                                    <?php
                                    $c++;
                        ...
                        <div class="ibox-content">
                            <div class="table-responsive">
                                <table class="footable table table-striped" id="myTable2">
                                    ...
                                    <tr>
                                        <th>
                                            <center>ESPESOR MAXIMO.</center>
                                        </th>
                                        <th>
                                            <center><P id="espmaximo">?</P></center>
                                        </th>
                                        <th>
                                            <center>ESPESOR MINIMO</center>
                                        </th>
                                        <th>
                                            <center><P id="espminimo">?</P></center>
                                        </th>
                                    </tr>
                                    </thead>
                                    <tbody>
