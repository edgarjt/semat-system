...
if (!empty($_SESSION)) {
    if (isset($_SESSION['id_usuario'])) {
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group"><label class="col-sm-2 control-label">Subdireccion:</label>
                                                        <div><SELECT id="subdireccion" NAME="subdireccion" SIZE=1
                                                                     class="form-control" onchange="changeContratos()">
                                                                <OPTION VALUE="-1">Seleccionar una sub-direccion
                                                                </OPTION>
                                                                <?php
                                                    ...
                                                    <div class="form-group"><label class="col-sm-6 control-label">Tipo
                                                            de trabajo</label>
                                                        <div><SELECT id="tipo_trabajo" NAME="tipo_trabajo" SIZE=1
                                                                     class="form-control">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group"><label class="col-sm-6 control-label">Contrato</label>
                                                        <div><SELECT id="contrato" NAME="contrato" SIZE=1
                                                                     class="form-control">
                                                                <option value="-1">Todos</option>
                                                                <?php
                                                    ...
                                                    <div class="form-group">
                                                        <div>
                                                            <button class="btn btn-primary" type="submit">Consultar
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group"><label class="col-sm-6 control-label">Compañia</label>
                                                        <div><SELECT id="compania" NAME="compania" SIZE=1
                                                                     class="form-control">
                                                                <option value="-1">Todos</option>
                                                                <?php
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="ibox-content">
                                    <table class="table table-striped">
                                        ...
                                        <tr bgcolor="#A9F5BC">
                                            <td><img width="30" height="30" src="../img/ETB.png">Envolvente tipo "B"
                                                (ETB)
                                            </td>
                                            <td><img width="30" height="30" src="../img/ECB.png">Envolvente tipo "B" CON
                                                Boyler (ECB)
                                            </td>
                                            <td><img width="30" height="30" src="../img/BRE.png">Envolvente tipo "B+RE"
                                                (BRE)
                                            </td>
                                            <td><img width="30" height="30" src="../img/GMP.png">Grapa metalica tipo
                                                PLIDCO (GMP)
                                            </td>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="footable table table-striped" data-page-size="20" data-filter=#filter
                                ...
                                <tr>
                                    ...
                                    <th>
                                        <center>IND. EXT.</center>
                                    </th>
                                    <th>
                                        <center>IND. INT.</center>
                                    </th>
                                    <th>
                                        <center>TOTAL IND.</center>
                                    </th>
                                    <th>
                                        <center>PERDIDA <br> (MENOR a 10%)</center>
                                    </th>
                                    <th>
                                        <center>PERDIDA <br> (10 al 29.99)%</center>
                                    </th>
                                    <th>
                                        <center>PERDIDA <br>(30 al 79.99)%</center>
                                    </th>
                                    <th>
                                        <center>PERDIDA <br>(MAYOR al 80)%</center>
                                    </th>
                                    <!--<th>ACCIONES</th>-->
                                </tr>
                                </thead>
                                ...
                                foreach ($lineas as $value) {
                                    ...
                                    ?>
                                    <tr class="<?php echo ($cont % 2 == 0) ? "row_par" : "row_impar"; ?>"
                                        ...
                                        <td>
                                            <strong>
                                                <a target="_blank"
                                                   href="avance_linea_detalles.php?id_linea=<?php echo $linea->getId(); ?>&contrato=<?php echo $_POST['contrato']; ?>&subdireccion=<?php echo $_POST['subdireccion']; ?>&tipo_trabajo=<?php echo $_POST['tipo_trabajo'] ?>">
                    ...
                    <div class="modal-body">
                        <form id="form">
                            ...
                            <input type="hidden" id="nombre_foto" name="nombre_foto"
                                   value="<?php echo date("YmdHis") . rand(1, 90); ?>">
                        </form>
                    </div>
        ...
        <script async defer
                src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDQTpXj82d8UpCi97wzo_nKXL7nYrd4G70&signed_in=true&callback=initMap"></script>
        ...
        <script type="text/javascript">
            ...
            function cambiacolor_over(celda) {
                celda.style.backgroundColor = "#F5BCA9"
            }
